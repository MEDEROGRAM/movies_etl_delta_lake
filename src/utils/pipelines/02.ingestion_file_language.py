...
# MAGIC %md
# MAGIC #### Ingestion del archivo "languege.csv"
...
# MAGIC %md
# MAGIC ##### Cambiar el nombre de las culumnas según lo "Requerido"
...
# MAGIC %md
# MAGIC ##### Paso 4 - Agregar la columna "Ingestion Date" "Environmen" al DataFrame
...
language_final_df = add_insgestion_date(language_renamed_df) \
