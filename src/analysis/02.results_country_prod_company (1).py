...
countries_prod_coun_df = countries_df.join(productions_countries_df,
                                      ...
                                      "inner") \
                                          .select(countries_df.country_name, countries_df.country_id,
...
production_com_mov_com_df = productions_companies_df.join(movies_companies_df,
                                   ...
                                   "inner") \
                                       .select(productions_companies_df.company_name, productions_companies_df.company_id,
...
results_df = results_movies_countries_productios_df \
    .select(movies_filter_df.movie_id, "country_id", "company_id", "title", "budget", "revenue", "release_date", "duration_time", "company_name", "country_name") \
